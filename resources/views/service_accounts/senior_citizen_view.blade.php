                    ...
                    <tbody>
                        @foreach ($serviceAccounts as $item)
                            <tr>
                                ...
                                <td>{{ $item->SeniorCitizenDateApplied != null ? date('M d, Y', strtotime($item->SeniorCitizenDateApplied)) : '' }}</td>
                                <td>{{ $item->SeniorCitizenDateExpire != null ? date('M d, Y', strtotime($item->SeniorCitizenDateExpire)) : ''}}</td>
                                <td class="text-right">
