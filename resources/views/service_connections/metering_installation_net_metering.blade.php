...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h4 style="display: inline; margin-right: 15px;">Metering Installation Report - Net Metering</h4>
            </div>
        </div>
    </div>
</section>
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card shadow-none">
            {!! Form::open(['route' => 'serviceConnections.metering-installation-net-metering', 'method' => 'GET']) !!}
            <div class="card-body">
                <div class="row">
    ...
    <script>
        $(document).ready(function() {
            $('#download').on('click', function(e) {
                e.preventDefault()
                window.location.href = "{{ url('/service_connections/download-net-metering-installation-report') }}/" + $('#From').val() + "/" + $('#To').val()
            })
        })
    </script>
@endpush