    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="input-group">
                ...
                {!! Form::text('ServiceAccountName', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
            </div>
        </div>
    </div> 
</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-7">
            <div class="input-group">
                ...
                {!! Form::text('ContactNumber', null, ['class' => 'form-control','maxlength' => 300,'maxlength' => 300, 'placeholder' => 'Contact Numbers']) !!}
            </div>
        </div>
    </div> 
</div>
...
{{-- <p id="Def_Brgy" style="display: none;">{{ $cond=='new' ? '' : $serviceConnections->Barangay }}</p> --}}