...
<table class="table table-borderless table-sm table-hover">
   ...
   <tr>
      ...
      <td>
         <input type="text" id="meter-RequisitionByName" class="form-control form-control-xs" value="{{ strtoupper(Auth::user()->name) }}">
      </td>
      <td>OR No : </td>
      <td>
   ...
   <tr>
      <td>Requested By :</td>
      <td colspan="2">
         <input type="text" id="meter-RequestedBy" class="form-control form-control-xs" value="{{ strtoupper(Auth::user()->name) }}">
      </td> 
   </tr>
</table>
