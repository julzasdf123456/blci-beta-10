...
<table class="table table-borderless table-sm table-hover">
   ...
   <tr>
      ...
      <td>
         <input type="text" id="meter-TypeOfServiceId" class="form-control form-control-xs" value="{{ $whHeadMeters != null ? $whHeadMeters->serv_code : ($serviceAppliedFor != null ? $serviceAppliedFor->id : '7') }}" readonly>
      </td>
   </tr>
   <tr>
      <td>Project Code :</td>
   ...
   <tr>
      <td>Requested By :</td>
      <td colspan="2">
         <input type="text" id="meter-RequestedBy" class="form-control form-control-xs" value="{{ $whHeadMeters != null ? $whHeadMeters->chkby : strtoupper(Auth::user()->name) }}">
      </td> 
   </tr>
</table>
