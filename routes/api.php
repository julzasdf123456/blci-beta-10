...
Route::post('applications-logger', [ServiceConnectionInspectionsAPI::class, 'applicationsLogger']);
...
Route::post('receive-line-and-metering', [ServiceConnectionsEnergization::class, 'receiveLineAndMetering']);
...
Route::get('download-accounts', [ReadAndBillAPI::class, 'downloadAccounts'])->name('readAndBillApi.download-accounts');
